...
public class DTEXTIL extends CarrerasActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Diseño Textil");
        ...
        materias.add(new Materia("Fundamentos Geométricos del Textil", false));
        ...
        //Nivel 2
        materias.add(new Materia("Proyecto Textil I", false));
        materias.add(new Materia("Procesos de Teñido, Estampado y Terminación", false));
        ...
        materias.add(new Materia("Técnicas de Producción Textil I", false));
        materias.add(new Materia("Técnicas de Producción Textil II", false));

        //Nivel 3
        materias.add(new Materia("Historia del Textil", false));
        materias.add(new Materia("Proyecto Textil II", false));
        materias.add(new Materia("Proyecto Textil III", false));
        ...
        materias.add(new Materia("Técnicas de Producción Textil III", false));
        materias.add(new Materia("Comercialización y Mercado II", false));
        materias.add(new Materia("Técnicas de Producción de Textil IV", false));

        //Nivel 4
        materias.add(new Materia("Proyecto Textil IV", false));
